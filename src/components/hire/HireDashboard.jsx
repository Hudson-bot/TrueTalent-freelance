  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-3">
        ...
        <span className={`px-2 py-1 text-xs rounded-full ${project.status === 'open' ? 'bg-green-100 text-green-800' :
    ...
    <div className="flex items-center justify-between p-3 bg-white rounded-lg shadow-sm mb-2 border border-gray-100">
      <div className="flex items-center">
        <button
          ...
          className={`w-5 h-5 rounded-full border flex items-center justify-center mr-3 ${task.completed ? 'bg-blue-500 border-blue-500' : 'border-gray-300'
            }`}
        >
...
const HireDashboard = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      <TalentSidebar activeTab="projects" />
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <div className="flex items-center text-sm text-gray-500">
                    ...
                    <span className={`px-2 py-1 text-xs rounded-full ${selectedProject.status === 'open' ? 'bg-green-100 text-green-800' :
              ...
              <div className="border-b border-gray-200 mb-6 overflow-x-auto">
                <nav className="flex space-x-4 sm:space-x-8 whitespace-nowrap">
                  ...
                  <button
                    ...
                    className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'proposals'
                        ? 'border-blue-500 text-blue-600'
                        : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                      }`}
                  >
